...
### EDP
In the **Engineering Design Process**, its pretty obvious we have complete the first stage of defining the problem which is choosing a topic and tool and i has definety done that already. I think we are on stage 2 of researching the problem because we are researching about our tool and how to use it. We have not tried to make our project yet, so we are still in the middle of researching. 
### Skills 
##### How to read
I developed the skill of reading because i had to read a ton of documenations to even began coding. I had no idea how to install Phaser and every single time i read, i felt that a huge chunk of information was missing because i did not get what it said at all. Through rereading multilple times, I start to understand what the documents are saying. 
